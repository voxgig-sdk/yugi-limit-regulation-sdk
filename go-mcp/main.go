// Command YugiLimitRegulation-mcp is an MCP server exposing the YugiLimitRegulation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	YugiLimitRegulation_list  — list records of an entity
//	YugiLimitRegulation_load  — load a single record of an entity
//
