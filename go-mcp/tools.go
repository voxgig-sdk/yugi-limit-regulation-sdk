...
type Args struct {
	Entity string         `json:"entity" jsonschema:"currentvector"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.YugiLimitRegulationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "yugi-limit-regulation_list",
		Description: "List records from YugiLimitRegulation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "yugi-limit-regulation_load",
		Description: "Load a single record from YugiLimitRegulation. " +
...
func runOp(client *sdk.YugiLimitRegulationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.YugiLimitRegulationSDK, name string) (sdk.YugiLimitRegulationEntity, error) {
	switch strings.ToLower(name) {
	case "currentvector":
		return client.Currentvector(nil), nil
