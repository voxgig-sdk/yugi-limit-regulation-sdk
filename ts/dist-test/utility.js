...
function envOverride(m) {
    if ('TRUE' === process.env.YUGI_LIMIT_REGULATION_TEST_LIVE ||
        'TRUE' === process.env.YUGI_LIMIT_REGULATION_TEST_OVERRIDE) {
    ...
    m.YUGI_LIMIT_REGULATION_TEST_EXPLAIN = process.env.YUGI_LIMIT_REGULATION_TEST_EXPLAIN || m.YUGI_LIMIT_REGULATION_TEST_EXPLAIN;
    return m;
}
