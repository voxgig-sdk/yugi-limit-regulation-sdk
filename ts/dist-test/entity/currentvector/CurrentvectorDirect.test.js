...
(0, node_test_1.describe)('CurrentvectorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.YugiLimitRegulationSDK({
    ...
    (0, node_test_1.test)('direct-list-currentvector', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-currentvector', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.YUGI_LIMIT_REGULATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.YugiLimitRegulationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['YUGI_LIMIT_REGULATION_TEST_CURRENTVECTOR_ENTID'];
    ...
    const client = new __1.YugiLimitRegulationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CurrentvectorDirect.test.js.map