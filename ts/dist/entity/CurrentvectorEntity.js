...
class CurrentvectorEntity extends YugiLimitRegulationEntityBase_1.YugiLimitRegulationEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'currentvector';
        this.name_ = 'currentvector';
        this.Name = 'Currentvector';
    }
    make() {
        return new CurrentvectorEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Currentvector[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.CurrentvectorEntity = CurrentvectorEntity;
//# sourceMappingURL=CurrentvectorEntity.js.map