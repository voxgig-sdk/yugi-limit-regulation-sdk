...
function runner.env_override(m)
  local live = runner.getenv("YUGI_LIMIT_REGULATION_TEST_LIVE")
  local override = runner.getenv("YUGI_LIMIT_REGULATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("YUGI_LIMIT_REGULATION_TEST_EXPLAIN")
