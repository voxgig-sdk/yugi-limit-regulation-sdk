...
describe("CurrentvectorDirect", function()
  it("should direct-list-currentvector", function()
    local setup = currentvector_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-currentvector", setup.live and "live" or "unit")
...
function currentvector_direct_setup(mockres)
