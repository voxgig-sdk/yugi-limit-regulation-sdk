# YugiLimitRegulation Lua SDK Reference

Complete API reference for the YugiLimitRegulation Lua SDK.
...
```lua
local results, err = client:Currentvector(nil):list(nil, nil)
```
