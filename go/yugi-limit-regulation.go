...
// instead of `sdk.NewYugiLimitRegulationSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *YugiLimitRegulationSDK  { return NewYugiLimitRegulationSDK(nil) }
func Test() *YugiLimitRegulationSDK { return TestSDK(nil, nil) }
