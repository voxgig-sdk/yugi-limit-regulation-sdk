...
type YugiLimitRegulationSDK struct {
	Mode     string
...
func (sdk *YugiLimitRegulationSDK) OptionsMap() map[string]any {
...
func (sdk *YugiLimitRegulationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *YugiLimitRegulationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *YugiLimitRegulationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YugiLimitRegulationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *YugiLimitRegulationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *YugiLimitRegulationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("YugiLimitRegulationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *YugiLimitRegulationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YugiLimitRegulationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("YugiLimitRegulationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *YugiLimitRegulationSDK {
	...
	sdk := NewYugiLimitRegulationSDK(sdkopts)
	sdk.Mode = "test"
