...
type CurrentvectorEntity struct {
	name    string
	client  *core.YugiLimitRegulationSDK
...
func NewCurrentvectorEntity(client *core.YugiLimitRegulationSDK, entopts map[string]any) *CurrentvectorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CurrentvectorEntity) GetName() string { return e.name }
...
func (e *CurrentvectorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CurrentvectorEntity) Deleted() bool {
	return e.deleted
}


func (e *CurrentvectorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCurrentvectorEntity(e.client, opts)
}

func (e *CurrentvectorEntity) Data(args ...any) any {
...
func (e *CurrentvectorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Currentvector; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CurrentvectorEntity) DataTyped(data ...Currentvector) Currentvector {
	if len(data) > 0 {
		return typedFrom[Currentvector](e.Data(asMap(data[0])))
	}
	return typedFrom[Currentvector](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Currentvector (all fields
// optional at the wire level).
func (e *CurrentvectorEntity) MatchTyped(match ...Currentvector) Currentvector {
	if len(match) > 0 {
		return typedFrom[Currentvector](e.Match(asMap(match[0])))
	}
	return typedFrom[Currentvector](e.Match())
}
...
func (e *CurrentvectorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CurrentvectorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CurrentvectorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CurrentvectorListMatch and returns []Currentvector. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CurrentvectorEntity) ListTyped(reqmatch CurrentvectorListMatch, ctrl map[string]any) ([]Currentvector, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Currentvector](res), nil
}



func (e *CurrentvectorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CurrentvectorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CurrentvectorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CurrentvectorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
