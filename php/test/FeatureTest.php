...
// YugiLimitRegulation SDK feature test
//
...
class FtCtrl extends YugiLimitRegulationControl
{
...
class FtClient
{
    ...
    private YugiLimitRegulationUtility $utility;

    public function __construct(YugiLimitRegulationUtility $utility, array $options)
    {
    ...
    public function get_utility(): YugiLimitRegulationUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (YugiLimitRegulationContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public YugiLimitRegulationContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (YugiLimitRegulationContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = YugiLimitRegulationConfig::make_feature($name);
    ...
    private static function buildUrl(YugiLimitRegulationSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof YugiLimitRegulationError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new YugiLimitRegulationResponse($fetched);
        }
    ...
    private function fail(YugiLimitRegulationContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (YugiLimitRegulationContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
