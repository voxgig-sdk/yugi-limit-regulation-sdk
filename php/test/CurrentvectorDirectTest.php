...
class CurrentvectorDirectTest extends TestCase
{
    public function test_direct_list_currentvector(): void
    {
        $setup = currentvector_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-currentvector", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
