...
// YugiLimitRegulation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YugiLimitRegulationSDK::test)
...
{
    private const SDK_CLASS = 'YugiLimitRegulationSDK';
    ...
    private const SDK_BASE = 'yugilimitregulation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../yugilimitregulation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
