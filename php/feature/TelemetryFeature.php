...
// YugiLimitRegulation SDK telemetry feature
...
class YugiLimitRegulationTelemetryFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _close(YugiLimitRegulationContext $ctx, bool $ok): void
    {
