...
// YugiLimitRegulation SDK netsim feature
...
class YugiLimitRegulationNetsimFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _simulate(YugiLimitRegulationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YugiLimitRegulationContext $ctx, array $applied): void
    {
        $client = $this->client;
