...
// YugiLimitRegulation SDK debug feature
...
class YugiLimitRegulationDebugFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _finish(YugiLimitRegulationContext $ctx, bool $ok): void
    {
