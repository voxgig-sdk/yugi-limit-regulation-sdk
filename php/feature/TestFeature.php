...
// YugiLimitRegulation SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class YugiLimitRegulationTestFeature extends YugiLimitRegulationBaseFeature
{
    ...
    public function init(YugiLimitRegulationContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (YugiLimitRegulationContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = YugiLimitRegulationParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (YugiLimitRegulationContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(YugiLimitRegulationContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = YugiLimitRegulationParam::call($ctx, $k);
