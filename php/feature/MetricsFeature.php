...
// YugiLimitRegulation SDK metrics feature
...
class YugiLimitRegulationMetricsFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _record(YugiLimitRegulationContext $ctx, bool $ok): void
    {
