...
// YugiLimitRegulation SDK clienttrack feature
...
class YugiLimitRegulationClienttrackFeature extends YugiLimitRegulationBaseFeature
{
    ...
    public function PostConstruct(YugiLimitRegulationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YugiLimitRegulation-SDK';
