...
// YugiLimitRegulation SDK timeout feature
...
class YugiLimitRegulationTimeoutFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _with_timeout(YugiLimitRegulationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YugiLimitRegulationContext $_ctx, float $ms): void
    {
        $client = $this->client;
