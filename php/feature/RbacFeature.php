...
// YugiLimitRegulation SDK rbac feature
...
class YugiLimitRegulationRbacFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _required(YugiLimitRegulationContext $ctx): ?string
    {
    ...
    private function _reject(YugiLimitRegulationContext $ctx, string $required): void
    {
    ...
    private function _track(YugiLimitRegulationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
