...
// YugiLimitRegulation SDK cache feature
...
class YugiLimitRegulationCacheFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _through(YugiLimitRegulationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
