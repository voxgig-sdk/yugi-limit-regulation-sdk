...
class YugiLimitRegulationSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = YugiLimitRegulationHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = YugiLimitRegulationHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!YugiLimitRegulationFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, YugiLimitRegulationFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return YugiLimitRegulationUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = YugiLimitRegulationHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = YugiLimitRegulationHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = YugiLimitRegulationHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new YugiLimitRegulationError($op . "_allow",
                "YugiLimitRegulationSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = YugiLimitRegulationHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new YugiLimitRegulationError("graphql_error",
                "YugiLimitRegulationSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Currentvector($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_currentvector === null) {
                $this->_currentvector = new CurrentvectorEntity($this, null);
            }
            return $this->_currentvector;
        }
        return new CurrentvectorEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new YugiLimitRegulationSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
