...
The PHP SDK for the YugiLimitRegulation API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Currentvector(null)->list(null, null);
...
[$result, $err] = $client->YugiLimitRegulation(null)->load(
    ["id" => "test01"], null
);
