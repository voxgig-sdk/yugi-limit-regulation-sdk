...
// YugiLimitRegulation SDK utility type

class YugiLimitRegulationUtility
{
    ...
    public static function copy(YugiLimitRegulationUtility $src): YugiLimitRegulationUtility
    {
        $u = new YugiLimitRegulationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
