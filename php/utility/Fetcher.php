...
// YugiLimitRegulation SDK utility: fetcher

class YugiLimitRegulationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YugiLimitRegulationSDK/1.0)';
    ...
    public static function call(YugiLimitRegulationContext $ctx, string $fullurl, array $fetchdef): array
    {
