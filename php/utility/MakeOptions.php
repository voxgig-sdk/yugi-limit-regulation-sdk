...
// YugiLimitRegulation SDK utility: make_options

class YugiLimitRegulationMakeOptions
{
    ...
    public static function call(YugiLimitRegulationContext $ctx): array
    {
        ...
        //
        // `YugiLimitRegulationSchema::optspec()` is built from the model:
        ...
        $optspec = YugiLimitRegulationSchema::optspec();
