...
// YugiLimitRegulation SDK utility: graphql
//
...
class YugiLimitRegulationGraphql
{
    ...
    // equivalent.
    public static function body(YugiLimitRegulationContext $ctx): mixed
    {
    ...
    public static function errors(YugiLimitRegulationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
