...
|---|---|---|
| `ts/` | @voxgig-sdk/yugi-limit-regulation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yugi-limit-regulation-sdk \
      --repository voxgig-sdk/yugi-limit-regulation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yugi-limit-regulation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yugi-limit-regulation-sdk --id=<id>` removes it.
