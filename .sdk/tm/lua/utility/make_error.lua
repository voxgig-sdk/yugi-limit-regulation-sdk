...
local function make_error_util(ctx, err)
  ...
  local msg = "YugiLimitRegulationSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = YugiLimitRegulationError.new("", msg, ctx)
  sdk_err.result = ctx.utility.clean(ctx, result)
  sdk_err.spec = ctx.utility.clean(ctx, spec)

  if type(err) == "table" and getmetatable(err) == YugiLimitRegulationError then
