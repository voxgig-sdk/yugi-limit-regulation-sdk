...
from projectname_sdk.core.control import YugiLimitRegulationControl
...
class YugiLimitRegulationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = YugiLimitRegulationControl()
        ...
        if isinstance(sp, YugiLimitRegulationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, YugiLimitRegulationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, YugiLimitRegulationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return YugiLimitRegulationOperation({})
        ...
        op = YugiLimitRegulationOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return YugiLimitRegulationError(code, msg, self)
