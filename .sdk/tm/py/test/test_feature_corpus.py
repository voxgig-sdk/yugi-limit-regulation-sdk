# YugiLimitRegulation SDK feature corpus test
#
...
def _client(kase):
    ...
    YugiLimitRegulationSDK(...), not YugiLimitRegulationSDK.test(...): the `test` feature is
    ...
    return YugiLimitRegulationSDK(opts)
