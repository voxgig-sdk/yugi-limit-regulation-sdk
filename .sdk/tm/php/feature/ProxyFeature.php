...
// YugiLimitRegulation SDK proxy feature
...
class YugiLimitRegulationProxyFeature extends YugiLimitRegulationBaseFeature
{
    ...
    public function init(YugiLimitRegulationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YugiLimitRegulationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
