...
// YugiLimitRegulation SDK retry feature
...
class YugiLimitRegulationRetryFeature extends YugiLimitRegulationBaseFeature
{
    ...
    public function init(YugiLimitRegulationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YugiLimitRegulationContext $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(YugiLimitRegulationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(YugiLimitRegulationContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
