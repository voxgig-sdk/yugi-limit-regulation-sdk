...
// YugiLimitRegulation SDK audit feature
...
class YugiLimitRegulationAuditFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _emit(YugiLimitRegulationContext $ctx, string $outcome): void
    {
