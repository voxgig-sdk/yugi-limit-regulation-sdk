...
// YugiLimitRegulation SDK ratelimit feature
...
class YugiLimitRegulationRatelimitFeature extends YugiLimitRegulationBaseFeature
{
    ...
    private function _acquire(YugiLimitRegulationContext $ctx): void
    {
    ...
    private function _track(YugiLimitRegulationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
