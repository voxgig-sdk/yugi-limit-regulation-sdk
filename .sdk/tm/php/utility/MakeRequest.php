...
// YugiLimitRegulation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YugiLimitRegulationMakeRequest
{
    public static function call(YugiLimitRegulationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YugiLimitRegulationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YugiLimitRegulationResponse($fetched);
        } else {
