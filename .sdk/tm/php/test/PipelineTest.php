...
// YugiLimitRegulation SDK pipeline test
//
...
{
    private static function utility(): YugiLimitRegulationUtility
    {
        return new YugiLimitRegulationUtility();
    }
    ...
    private static function ctx(array $over = []): YugiLimitRegulationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new YugiLimitRegulationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new YugiLimitRegulationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof YugiLimitRegulationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new YugiLimitRegulationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = YugiLimitRegulationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new YugiLimitRegulationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = YugiLimitRegulationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new YugiLimitRegulationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = YugiLimitRegulationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YugiLimitRegulationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = YugiLimitRegulationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new YugiLimitRegulationResponse([]),
            'result' => new YugiLimitRegulationResult([]),
        ]);
        [, $err] = YugiLimitRegulationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new YugiLimitRegulationSpec([]),
            'response' => null,
            'result' => new YugiLimitRegulationResult([]),
        ]);
        [, $err] = YugiLimitRegulationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new YugiLimitRegulationSpec(['step' => 's']),
            'response' => new YugiLimitRegulationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new YugiLimitRegulationResult([]),
        ]);
        [, $err] = YugiLimitRegulationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new YugiLimitRegulationSpec(['step' => 's']),
            'response' => new YugiLimitRegulationResponse(self::resp(200, ['v' => 1])),
            'result' => new YugiLimitRegulationResult([]),
        ]);
        [, $err] = YugiLimitRegulationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new YugiLimitRegulationSpec(['step' => 's']),
            'response' => new YugiLimitRegulationResponse(self::resp(200, ['v' => 2])),
            'result' => new YugiLimitRegulationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        YugiLimitRegulationMakeResponse::call($ctx);
    ...
    {
        $preset = new YugiLimitRegulationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new YugiLimitRegulationSpec([]),
            'response' => new YugiLimitRegulationResponse([]),
            'result' => new YugiLimitRegulationResult([]),
        ...
        [$got, $err] = YugiLimitRegulationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new YugiLimitRegulationResult([])]);
        [, $err] = YugiLimitRegulationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new YugiLimitRegulationSpec([]), 'result' => null]);
        [, $err] = YugiLimitRegulationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YugiLimitRegulationSpec(['step' => 's']),
            'result' => new YugiLimitRegulationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new YugiLimitRegulationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YugiLimitRegulationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YugiLimitRegulationSpec(['step' => 's']),
            'result' => new YugiLimitRegulationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new YugiLimitRegulationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YugiLimitRegulationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YugiLimitRegulationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new YugiLimitRegulationSpec([]),
            'result' => new YugiLimitRegulationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = YugiLimitRegulationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YugiLimitRegulationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new YugiLimitRegulationError('boom', 'boom');
        $utility->fetcher = function (YugiLimitRegulationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YugiLimitRegulationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = YugiLimitRegulationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (YugiLimitRegulationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = YugiLimitRegulationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(YugiLimitRegulationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        YugiLimitRegulationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (YugiLimitRegulationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YugiLimitRegulationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = YugiLimitRegulationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new YugiLimitRegulationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new YugiLimitRegulationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = YugiLimitRegulationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = YugiLimitRegulationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = YugiLimitRegulationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new YugiLimitRegulationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, YugiLimitRegulationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new YugiLimitRegulationResult(['ok' => false])]);
        $this->expectException(YugiLimitRegulationError::class);
        YugiLimitRegulationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new YugiLimitRegulationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', YugiLimitRegulationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        YugiLimitRegulationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new YugiLimitRegulationBaseFeature();
        $b = new YugiLimitRegulationBaseFeature();
        YugiLimitRegulationFeatureAdd::call($ctx, $a);
        YugiLimitRegulationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): YugiLimitRegulationBaseFeature
    {
        $f = new YugiLimitRegulationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        YugiLimitRegulationFeatureAdd::call($ctx, self::named_feature('a'));
        YugiLimitRegulationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        YugiLimitRegulationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        YugiLimitRegulationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        YugiLimitRegulationFeatureAdd::call($ctx, $replace);
        ...
        YugiLimitRegulationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): YugiLimitRegulationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new YugiLimitRegulationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YugiLimitRegulationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        YugiLimitRegulationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new YugiLimitRegulationResponse(['headers' => null]),
            'result' => new YugiLimitRegulationResult([]),
        ]);
        YugiLimitRegulationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        YugiLimitRegulationResultBody::call($ctx);
