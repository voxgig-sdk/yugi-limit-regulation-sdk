...
// YugiLimitRegulation SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YugiLimitRegulationOmni::makeStructRunner(
    ...
    {
        return YugiLimitRegulationOmni::objmodel(YugiLimitRegulationOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return YugiLimitRegulationOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return YugiLimitRegulationOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YugiLimitRegulationOmni::structfix($now, Struct::undef()))
                        !== json_encode(YugiLimitRegulationOmni::structfix($val, Struct::undef()))) {
