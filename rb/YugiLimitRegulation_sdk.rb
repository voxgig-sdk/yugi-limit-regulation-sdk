...
require_relative 'YugiLimitRegulation_types'
...
class YugiLimitRegulationSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = YugiLimitRegulationHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = YugiLimitRegulationHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, YugiLimitRegulationFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    YugiLimitRegulationUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = YugiLimitRegulationHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = YugiLimitRegulationHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = YugiLimitRegulationHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => YugiLimitRegulationError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue YugiLimitRegulationError => err
    ...
    if fetched.is_a?(Hash)
      status = YugiLimitRegulationHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = YugiLimitRegulationError.new(
        "graphql_error", "YugiLimitRegulationSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = YugiLimitRegulationSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
