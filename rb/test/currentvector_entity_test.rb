...
class CurrentvectorEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set YUGI_LIMIT_REGULATION_TEST_CURRENTVECTOR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def currentvector_basic_setup(extra)
  ...
  entid_env_raw = ENV["YUGI_LIMIT_REGULATION_TEST_CURRENTVECTOR_ENTID"]
