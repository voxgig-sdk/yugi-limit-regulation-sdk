...
#      offline in seeded test mode (YugiLimitRegulationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "YugiLimitRegulation_sdk.rb")
  SDK_CLASS = "YugiLimitRegulationSDK"
  ...
  SDK_BASE = "YugiLimitRegulation_sdk"
