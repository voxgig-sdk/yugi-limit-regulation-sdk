...
The Ruby SDK for the YugiLimitRegulation API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.YugiLimitRegulation(nil).load(
  { "id" => "test01" }, nil
)
