# YugiLimitRegulation Ruby SDK



The Ruby SDK for the YugiLimitRegulation API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `YugiLimitRegulationError` (a `StandardError` subclass), so wrap
...
```
rb/
├── YugiLimitRegulation_sdk.rb       -- Main SDK module
...
The main module (`YugiLimitRegulation_sdk`) exports the SDK class
