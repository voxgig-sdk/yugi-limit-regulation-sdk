...
func registerSDKWords(r *eng.Registry, client *sdk.YugiLimitRegulationSDK) {
...
func runOp(client *sdk.YugiLimitRegulationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
