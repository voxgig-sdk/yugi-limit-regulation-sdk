...
from yugilimitregulation_sdk.utility import register

# Load features
from yugilimitregulation_sdk.feature.base_feature import YugiLimitRegulationBaseFeature
from yugilimitregulation_sdk.features import _has_feature, _make_feature
...
class YugiLimitRegulationSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = YugiLimitRegulationUtility()
        self._utility = utility

        from yugilimitregulation_sdk.config import shared_config
    ...
    def get_utility(self):
        return YugiLimitRegulationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YugiLimitRegulationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Currentvector(self, data=None) -> "CurrentvectorEntity":
        ...
        from yugilimitregulation_sdk.entity.currentvector_entity import CurrentvectorEntity
