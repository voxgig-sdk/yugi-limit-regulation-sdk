...
from yugilimitregulation_sdk.yugilimitregulation_types import (
    Currentvector,
...
class CurrentvectorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CurrentvectorEntity(self._client, opts)
    ...
    def data_get(self) -> Currentvector:
    ...
    def match_get(self) -> Currentvector:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Currentvector]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Currentvector().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
