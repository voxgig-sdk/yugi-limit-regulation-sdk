# YugiLimitRegulation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YugiLimitRegulationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YugiLimitRegulationSDK(...) and YugiLimitRegulationSDK.test(...) become
#      YugiLimitRegulationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yugilimitregulation_sdk"
_SDK_CLASS = "YugiLimitRegulationSDK"
